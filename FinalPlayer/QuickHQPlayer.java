...
public class QuickHQPlayer extends BasePlayer {
	...
	public QuickHQPlayer(RobotController rc) {
		super(rc);
		...
		try{			
			...
			this.targetEncampments = rc.senseEncampmentSquares(currentLocation, 63, Team.NEUTRAL);
