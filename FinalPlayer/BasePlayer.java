...
public abstract class BasePlayer {
	...
	protected static int ArtilleryInProgressCountChannel = generator.nextInt(GameConstants.BROADCAST_MAX_CHANNELS); //Needs to be randomized
	...
	protected int getArtilleryCount() throws GameActionException{
