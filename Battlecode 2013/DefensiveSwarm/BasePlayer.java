...
public abstract class BasePlayer {
	...
	protected static int DefuseSpawnSquareChannel = 998; //Needs to be initialized
	protected static int ClearPathDirectionChannel; //Needs to be initialized
	protected static int TargetEncampmentsStartChannel = 1; //Needs to be initialized; Pointer to channel array start

	protected int rendezvousChannel = 16040;
